...
- (BOOL)application:(UIApplication*)application
  ...
  SSProductSearchViewController* searchVc =
      [[SSProductSearchViewController alloc] init];
...
- (void)setupServices {
  ...
  SSRequestOperationManager* requestOperationManager =
      [SSRequestOperationManager sharedManager];

  [requestOperationManager setupWithConfiguration:configuration];
}
